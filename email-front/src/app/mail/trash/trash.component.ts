...
export class TrashComponent implements OnInit {
  ...
  load(){
    this.api.getEmails(Globals.username, "Trash").subscribe(
  ...
  search(){
   ...
   this.api.filterEmails(Globals.username, "Trash",filters,this.searchString).subscribe(
    (mailList: Array<Email>) => {
      this.allEmails = [];
      mailList.forEach(
        (email: Email) => {
  ...
  sortEmails(){
    this.api.sortEmails(Globals.username, "Trash").subscribe(
      (mailList: Array<Email>) => {
        this.allEmails = [];
        mailList.forEach(
          (email: Email) => {
